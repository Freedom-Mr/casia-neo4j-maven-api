...
public class Neo4jParms {
    ...
    protected final static String HIERARCHY = "hierarchy";
    ...
    protected final static String RELATIONSHIP = "RELATIONSHIP";
    ...
    protected final static String POINT = "POINT";
    protected final static String DATE = "DATE";
    protected final static String TIME = "TIME";
    protected final static String LOCAL_TIME = "LOCAL_TIME";
    protected final static String LOCAL_DATE_TIME = "LOCAL_DATE_TIME";
    protected final static String DATE_TIME = "DATE_TIME";
